+
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\001\001\000\002\001\001\000\006\003\012\004\011\001" +
    "\001\000\002\001\001\000\002\001\001\000\006\003\034" +
    "\004\006\001\001\000\002\001\001\000\002\001\001\000" +
    "\006\003\021\004\006\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\006\003\031\004\006\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Sintactico$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // ini ::= PAR_IZQ union PAR_DER PUNTO hojafinal 
            {
              Object RESULT =null;
		...
		nodos temp = new nodos("Concatenación", "."); funciones.crearUnion(temp, valor1, valor2);
		...
		String val = (String)((java_cup.runtime.Symbol) CUP$Sintactico$stack.peek()).value;
		nodos temp = new nodos("hoja", val); RESULT=temp; funciones.crearHoja(temp);
              CUP$Sintactico$result = parser.getSymbolFactory().newSymbol("hojafinal",3, ((java_cup.runtime.Symbol)CUP$Sintactico$stack.peek()), ((java_cup.runtime.Symbol)CUP$Sintactico$stack.peek()), RESULT);
            }
          return CUP$Sintactico$result;
		...
		nodos temp = new nodos("Operador de alternancia", "|"); RESULT=temp; funciones.crearUnion(temp, valor1, valor2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // union ::= PAR_IZQ union ALTER union PAR_DER 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-3)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-3)).right;
		...
		nodos temp = new nodos("Operador de alternancia", "|"); RESULT=temp; funciones.crearUnion(temp, valor1, valor2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // union ::= union PUNTO union 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).right;
		...
		nodos temp = new nodos("Concatenación", "."); RESULT=temp; funciones.crearUnion(temp, valor1, valor2);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // union ::= PAR_IZQ union PUNTO union PAR_DER 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-3)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-3)).right;
		...
		nodos temp = new nodos("Operador uno o mas", "+"); RESULT=temp; funciones.conectarNodo(temp, valor1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // union ::= PAR_IZQ union MAS PAR_DER 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).right;
		...
		nodos temp = new nodos("Operador uno o mas", "+"); RESULT=temp; funciones.conectarNodo(temp, valor1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // union ::= union INTERROGACION 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-1)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-1)).right;
		...
		nodos temp = new nodos("Operador cero o uno", "?"); RESULT=temp; funciones.conectarNodo(temp, valor1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // union ::= PAR_IZQ union INTERROGACION PAR_DER 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).right;
		...
		nodos temp = new nodos("Operador cero o mas", "*"); RESULT=temp; funciones.conectarNodo(temp, valor1);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // union ::= PAR_IZQ union ASTERISCO PAR_DER 
            {
              Object RESULT =null;
		int valor1left = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).left;
		int valor1right = ((java_cup.runtime.Symbol)CUP$Sintactico$stack.elementAt(CUP$Sintactico$top-2)).right;
		...
		RESULT=val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // union ::= PAR_IZQ hoja PAR_DER 
            {
              Object RESULT =null;
